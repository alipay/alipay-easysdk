...
public class Client extends BaseClient {
    ...
    public AlipayOpenApiGenericResponse execute(String method, java.util.Map<String, String> textParams, java.util.Map<String, Object> bizParams) throws Exception {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> respMap = _readAsJson(response_, method);
                if (_isCertMode()) {
                    if (_verify(respMap, _extractAlipayPublicKey(_getAlipayCertSN(respMap)))) {
                        return TeaModel.toModel(_toRespModel(respMap), new AlipayOpenApiGenericResponse());
                    }
