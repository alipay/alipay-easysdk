    ...
    public AlipayTradePayResponse pay(String subject, String outTradeNo, String totalAmount, String authCode) throws Exception {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> respMap = _readAsJson(response_, "alipay.trade.pay");
                if (_isCertMode()) {
                    if (_verify(respMap, _extractAlipayPublicKey(_getAlipayCertSN(respMap)))) {
                        return TeaModel.toModel(_toRespModel(respMap), new AlipayTradePayResponse());
                    }
    ...
    public AlipayTradePrecreateResponse preCreate(String subject, String outTradeNo, String totalAmount) throws Exception {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> respMap = _readAsJson(response_, "alipay.trade.precreate");
                if (_isCertMode()) {
                    if (_verify(respMap, _extractAlipayPublicKey(_getAlipayCertSN(respMap)))) {
                        return TeaModel.toModel(_toRespModel(respMap), new AlipayTradePrecreateResponse());
                    }
