...
public class Client extends BaseClient {
    ...
    public AlipayUserCertifyOpenInitializeResponse init(String outerOrderNo, String bizCode, IdentityParam identityParam, MerchantConfig merchantConfig) throws Exception {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> respMap = _readAsJson(response_, "alipay.user.certify.open.initialize");
                if (_isCertMode()) {
                    if (_verify(respMap, _extractAlipayPublicKey(_getAlipayCertSN(respMap)))) {
                        return TeaModel.toModel(_toRespModel(respMap), new AlipayUserCertifyOpenInitializeResponse());
                    }
    ...
    public AlipayUserCertifyOpenQueryResponse query(String certifyId) throws Exception {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> respMap = _readAsJson(response_, "alipay.user.certify.open.query");
                if (_isCertMode()) {
                    if (_verify(respMap, _extractAlipayPublicKey(_getAlipayCertSN(respMap)))) {
                        return TeaModel.toModel(_toRespModel(respMap), new AlipayUserCertifyOpenQueryResponse());
                    }
    ...
    public AlipayUserCertifyOpenCertifyResponse certify(String certifyId) throws Exception {
        ...
        java.util.Map<String, String> response = TeaConverter.buildMap(
            new TeaPair("body", _generatePage("GET", systemParams, bizParams, textParams, sign))
        );
